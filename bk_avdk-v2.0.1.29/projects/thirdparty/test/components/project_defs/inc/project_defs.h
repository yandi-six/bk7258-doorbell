...
#define  APP_COM_LOW_POWER        			APP_COM_BASE+34//cpu0发送lowpower cpu1关闭资源
#define  APP_COM_DOORBELL_RING					 APP_COM_BASE + 35 //cpu0让cpu1发布门铃按下消息				  
#define  CPU1_TELL_CPU0_SLEEP       			APP_COM_BASE+36//cpu1告诉cpu0睡觉
#define CPU1_TELL_CPU0_ONLINE 					APP_COM_BASE + 37
//+++++++++
